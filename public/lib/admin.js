...
(() => {
  ...
  const T = {
    zh: {
      ...
      'btn-edit':        '修改',
      'btn-save':        '保存',
      'btn-mark-permanent': '设为永久',
      'btn-mark-unlimited': '设为无限',
    ...
    en: {
      ...
      'btn-edit':        'Edit',
      'btn-save':        'Save',
      'btn-mark-permanent': 'Set permanent',
      'btn-mark-unlimited': 'Set unlimited',
      ...
      'btn-show':              'Show password',
      'btn-hide':              'Hide password',
      'btn-clear-password':    'Clear password',
